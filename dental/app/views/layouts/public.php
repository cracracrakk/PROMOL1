...
<header class="landing-nav">
    ...
    <div class="flex gap-1">
        ...
        <a href="<?= url('/contacto') ?>" class="btn btn-primary">Solicitar demo</a>
    </div>
</header>
...
<footer class="footer">
    <div class="footer-grid">
        <div>
            <div style="display:flex;gap:10px;align-items:center;color:#fff;margin-bottom:0.75rem;">
                ...
                <strong>DentalCore</strong>
            </div>
            <p style="color:#94a3b8;max-width:320px;">El software más completo para gestionar tu clínica dental: pacientes, citas, odontograma y facturación en una sola plataforma.</p>
        </div>
        <div>
            <h4>Producto</h4>
            <a href="<?= url('/funciones') ?>">Funciones</a>
    ...
    <div class="footer-bottom">© <?= date('Y') ?> DentalCore. Todos los derechos reservados.</div>
</footer>
</body>
</html>
