...
<div class="admin-layout">
    <aside class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="<?= url('/admin/newsletter') ?>" class="<?= activeNav('/admin/newsletter') ?>">
            ...
            <li><a href="<?= url('/admin/catalogos/mensajes') ?>" class="<?= activeNav('/admin/catalogos/mensajes') ?>">
            ...
            <li><a href="<?= url('/admin/catalogos/cabinas') ?>" class="<?= activeNav('/admin/catalogos/cabinas') ?>"><svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/></svg>Cabinas</a></li>
            <li><a href="<?= url('/admin/catalogos/proveedores') ?>" class="<?= activeNav('/admin/catalogos/proveedores') ?>"><svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M16 3h5v5M21 3l-7 7M8 21H3v-5M3 21l7-7"/></svg>Proveedores</a></li>
            <li><a href="<?= url('/admin/catalogos/promos') ?>" class="<?= activeNav('/admin/catalogos/promos') ?>"><svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><line x1="19" y1="5" x2="5" y2="19"/><circle cx="6.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/></svg>Promociones</a></li>
            <li><a href="<?= url('/admin/catalogos/galeria') ?>" class="<?= activeNav('/admin/catalogos/galeria') ?>"><svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>Galería</a></li>
            <li><a href="<?= url('/admin/catalogos/testimonios') ?>" class="<?= activeNav('/admin/catalogos/testimonios') ?>"><svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>Testimonios</a></li>
            ...
            <li><a href="<?= url('/admin/sistema/sucursales') ?>" class="<?= activeNav('/admin/sistema/sucursales') ?>"><svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>Sucursales</a></li>
            <li><a href="<?= url('/admin/import-export') ?>" class="<?= activeNav('/admin/import-export') ?>"><svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M17 8l-5-5-5 5M12 3v12"/></svg>Importar/Exportar</a></li>
